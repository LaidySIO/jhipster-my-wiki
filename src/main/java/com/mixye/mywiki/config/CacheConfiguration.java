...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mixye.mywiki.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mixye.mywiki.repository.UserRepository.USERS_BY_EMAIL_CACHE);
